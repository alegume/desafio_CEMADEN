...
high_threshold = np.percentile(mean_shap_values, 66)  # Top 33% is class A
low_threshold = np.percentile(mean_shap_values, 33)   # Bottom 33% is class C
...
colors = {'A': '#FF6347', 'B': '#FFA500', 'C': '#32CD32'}  # Same colors as NSE difference plot
...
feature_classes.to_csv('SHAP_agregado.csv', index=False)
